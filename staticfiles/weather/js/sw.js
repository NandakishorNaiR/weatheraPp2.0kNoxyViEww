...
self.addEventListener('fetch', (event) => {
  ...
  // Network-First with Cache-Fallback for weather data page or other HTML pages
  if (event.request.mode === 'navigate' || url.pathname.startsWith('/weather/')) {
    event.respondWith(
      fetch(event.request)
        .then((response) => {
